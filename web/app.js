...
(function () {
  var STRINGS = {
    en: {
      ...
      i1: '<a href="./app/dotrino-passmanager-0.1.3.zip" download>Download the extension</a> and unzip the folder.',
      ...
      i4: 'That is it. From then on it keeps your passwords encrypted in your browser, with nothing else to set up. If you would rather have them in one place for every browser you use, you can link a vault from the extension itself.',
