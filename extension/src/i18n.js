...
const STRINGS = {
  es: {
    ...
    fillThisFrom: 'Rellenar este valor con:',
    fillAll: 'Rellenar todos los valores',
    fillAllFrom: '¿Con cuál de estas?',
    fieldLogin: 'acceso',
    otherField: 'este campo',
    close: 'Cerrar',
  ...
  en: {
    ...
    fillThisFrom: 'Fill this value with:',
    fillAll: 'Fill every value',
    fillAllFrom: 'From which one?',
    fieldLogin: 'sign-in',
    otherField: 'this field',
    close: 'Close',
