...
const STRINGS = {
  es: {
    ...
    cvWhy: 'Tus contraseñas van cerradas y solo las abren los aparatos de tu cuenta. Esta contraseña es la copia de recuperación: lo único que puede volver a abrirlas si pierdes este navegador.',
    ...
    cvDone: (n) => n ? `Listo: la copia de recuperación cubre tus ${n} entrada${n === 1 ? '' : 's'}.` : 'Listo.',
    ...
    vtNoLogins: 'Todavía no hay ninguno. Créalo desde «Administrar los aparatos».',
    vtOpenTab: 'Hacer de bóveda',
    title: 'Dotrino',
    ...
    notSealed: 'Tu bóveda todavía no tiene contraseña de recuperación. Si pierdes este navegador, pierdes lo que guardaste.',
  ...
  en: {
    ...
    cvWhy: 'Your passwords are sealed and only your account devices can open them. This password is the recovery copy: the only thing that can open them again if you lose this browser.',
    ...
    cvDone: (n) => n ? `Done: the recovery copy covers your ${n} entr${n === 1 ? 'y' : 'ies'}.` : 'Done.',
    ...
    vtNoLogins: 'None yet. Create one from “Manage the devices”.',
    vtOpenTab: 'Act as the vault',
    title: 'Dotrino',
    ...
    notSealed: 'Your vault has no recovery password yet. If you lose this browser, you lose what you saved.',
