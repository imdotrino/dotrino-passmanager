...
import { openEntry, sealEntry, publicView, entryWho, normalizeSites } from '../model.js'
...
export class LocalVault {
  ...
  async patch (id, changes = {}) {
    ...
    const sites = (() => {
      // La lista puesta a mano MANDA sobre el «súmame este sitio» del guardado
      // automático: una es una decisión del usuario y el otro es una consecuencia de
      // dónde estaba. Vacía se queda vacía, que es «sirve en cualquier sitio».
