...
export const TYPES = ['login', 'note', 'card', 'webauthn']

const SEALED_FIELDS = ['username', 'secret', 'totp', 'notes']
...
export function newEntry (fields = {}) {
  ...
  return {
    ...
    // Política, no secreto: va en claro. Lo marcado así se pregunta SIEMPRE, por
    // muchas veces que se pida — la del banco, la del correo.
    alwaysAsk: !!fields.alwaysAsk,
